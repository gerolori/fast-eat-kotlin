...
@Composable
fun OrdersScreen(viewModel: MenuViewModel) {
    ...
    val mapViewportState =
        rememberSaveable(saver = MapViewportState.Saver) {
            viewModel.mapViewportState ?: MapViewportState().apply {
                setCameraOptions {
    ...
    DisposableEffect(mapViewportState) {
        viewModel.mapViewportState = mapViewportState
        onDispose { }
    }
